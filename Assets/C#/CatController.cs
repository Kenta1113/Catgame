...
public class CatMove : MonoBehaviour
{
    ...
    [SerializeField] private AudioClip _attackSound;         // ←追加：攻撃音
    [SerializeField] private float _attackVolume = 1.0f;     // ←追加：音量
    ...
    void Start()
    {
        ...
        audioSource = GetComponent<AudioSource>();           // ←追加：AudioSource取得
